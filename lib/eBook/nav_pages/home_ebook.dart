...
import 'package:read_on/feature/audio_feature/book_front_preview.dart';
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                children: [
                          ...
                          children: [
                            Text(
                              ebookApiController.todaysAttractionModel!.value
                                  .data![0].productList![0].name!,
                              style: Style.headerTextStyle(
                                  size * .05, Colors.black, FontWeight.w500),
                            ),
                            Text(
                              ebookApiController.todaysAttractionModel!.value
                                  .data![0].productList![0].wname!,
                            ...
                            Container(
                              ...
                              child: Text(
                                ebookApiController.todaysAttractionModel!.value
                                    .data![0].productList![0].categoryName!,
                  ...
                  Text(
                    ebookApiController.todaysAttractionModel!.value.data![0]
                        .productList![0].bookDescription!,
                    maxLines: 3,
            ...
            /// new books section
            EbookHomePageListPreview(
                title: 'নতুন বই', bookList: ebookApiController.newBookList),
            SizedBox(height: size * .02),
            ...
            Container(
              ...
              child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    String writterName = ebookApiController.writeModel.value
                                .data![index].writer![0].name!.length >
                            16
                        ? ebookApiController
                                .writeModel.value.data![index].writer![0].name!
                                .substring(0, 13) +
                            '...'
                        : ebookApiController
                            .writeModel.value.data![index].writer![0].name!;
            ...
            ListView.builder(
                ...
                physics: const ClampingScrollPhysics(),
                itemCount:
                    ebookApiController.homePageBookListModel.value.data!.length,
                itemBuilder: (context, index) {
                  return ebookApiController.homePageBookListModel.value
                          .data![index].product!.isEmpty
                      ? const SizedBox()
                      : EbookHomePageListPreview(
                          title: ebookApiController.homePageBookListModel.value
                              .data![index].catName!,
                          bookList: ebookApiController.homePageBookListModel
