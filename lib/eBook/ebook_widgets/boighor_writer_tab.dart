...
class _BoighorWriterTabPageState extends State<BoighorWriterTabPage> {
  ...
  Future<void> _customInit(EbookApiController ebookApiController) async {
    _count++;
    setState(() {
      _writterListLength = ebookApiController.writeModel.value.data!.length > 9
          ? 10
    ...
    await ebookApiController.getWriterWiseBookList(
        ebookApiController.writeModel.value.data![0].writer![0].id!.toString());

    // ignore: avoid_print
    print(
        'first writer name = ${ebookApiController.writeModel.value.data![0].writer![0].name}  book length = ${ebookApiController.writerWiseBookList.length}');
    setState(() {
      _bookListLength = ebookApiController.writerWiseBookList.length > 9
          ? 9
            ...
            Container(
              ...
              child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return _writterListLength > 9
                        ? index < _writterListLength - 1
                            ? GestureDetector(
                                onTap: () async {
                                  setState(() {
                                    _tappedIndex = index;
                                  ...
                                  await ebookApiController
                                      .getWriterWiseBookList(ebookApiController
                                          .writeModel
                                          .value
                                          .data![index]
                                          .writer![0]
                                          ...
                                          .toString());
                                  setState(() {
                                    _bookListLength = ebookApiController
                                                .writerWiseBookList.length >
                                            9
                                        ? 9
                                        : ebookApiController
                                            .writerWiseBookList.length;
                                  ...
                                  children: [
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        /// writer name
                                        Text(
                                          ebookApiController.writeModel.value
                                              .data![index].writer![0].name!,
