                        ...
                        items:   <BottomNavigationBarItem>[
                          BottomNavigationBarItem(
                            icon: InkWell(
                                                            ...
                                                            Padding(
                                                              ...
                                                              child: Container(
                                                                  ...
                                                                  decoration:  BoxDecoration(
                                                                      ...
                                                                      border: Border.all(color:circleColor==1? Colors.red:Colors.grey)

                                                                  ),
                                                                  child: Center(child: Text("অআ"))
                                                              ),
                                                            ),

                                                            Center(child: Text("ডিফল্ট ফন্ট",style: TextStyle(color: circleColor==1?Colors.red:Colors.black),))
                                                          ],
                                                        ),
                                                      ),
                                                      Padding(
                                                        ...
                                                        child:      InkWell(
                                                          ...
                                                          child: Column(
                                                            children: [
                                                              Padding(
                                                                ...
                                                                child: Container(
                                                                    ...
                                                                    decoration:  BoxDecoration(
                                                                        ...
                                                                        border: Border.all(color:circleColor==2? Colors.red:Colors.grey)
                                                              ...
                                                              Center(child: Text("সুলাইমান লিপি",style: TextStyle(color: circleColor==2?Colors.red:Colors.black),))
                                                            ],
                                                          ),
                                                        ),
                                                      ),
                                                      InkWell(
                                                        ...
                                                        child: Column(
                                                          children: [
                                                            Padding(
                                                              ...
                                                              child: Container(
                                                                  ...
                                                                  decoration:  BoxDecoration(
                                                                      ...
                                                                      border: Border.all(color:circleColor==3? Colors.red:Colors.grey)
                                                            ...
                                                            Center(child: Text("আদর্শ লিপি",style: TextStyle(color: circleColor==3?Colors.red:Colors.black),))
                                                          ],
                                                        ),
                                                      ),
                                                      Padding(
                                                       ...
                                                       //       selectedFont = 'Hind_Siliguri';
                                                          ...
                                                          child: Column(
                                                            children: [
                                                              Padding(
                                                                ...
                                                                child: Container(
                                                                    ...
                                                                    decoration:  BoxDecoration(
                                                                        ...
                                                                        border: Border.all(color:circleColor==4? Colors.red:Colors.grey)
                                                              ...
                                                              Center(child: Text("হিন্দ শিলিগুড়ি",style: TextStyle(color: circleColor==4?Colors.red:Colors.black),))
                                                            ],
                                                          ),
                                                        ),
                                                      ),
                                                      ...
                                                      //      selectedFont = 'SLIPI_N';
                                                        ...
                                                        child: Column(
                                                          children: [
                                                            Padding(
                                                              ...
                                                              child: Container(
                                                                  ...
                                                                  decoration:  BoxDecoration(
                                                                      ...
                                                                      border: Border.all(color:circleColor==5? Colors.red:Colors.grey)
                                                            ...
                                                            Center(child: Text("লিপি মল্লিকা",style: TextStyle(color: circleColor==5?Colors.red:Colors.black),))
                                                          ],
                                                        ),
                                                      ),
                                                      Padding(
                                                        ...
                                                        child:      InkWell(
                                                          ...
                                                          child: Column(
                                                            children: [
                                                              Padding(
                                                                ...
                                                                child: Container(
                                                                    ...
                                                                    decoration:  BoxDecoration(
                                                                        ...
                                                                        border: Border.all(color:circleColor==6? Colors.red:Colors.grey)
                                                              ...
                                                              Center(child: Text("গালাদা",style: TextStyle(color: circleColor==6?Colors.red:Colors.black),))
                                                            ],
                                                          ),
                                                        ),
                                                      ),
                                ...
                                child: Icon(Icons.text_fields_outlined,color: Colors.black,)),
                            title: Text(''),
                            backgroundColor: Colors.grey,
                          ),
                          BottomNavigationBarItem(
                            icon: InkWell(
                              ...
                              onTap: (){
                                ...
                                child: Icon(Icons.fit_screen,color: Colors.black,)),
                            title: Text(''),
                            backgroundColor: Colors.grey,
                          ),
                          BottomNavigationBarItem(
                                                    ...
                                                    child: Row(
                                                      children: [
                                                        InkWell(
                                                          onTap: (){
                                                            setState(() {
                                                              readingApiController.updateColorMode(Colors.black87);
                                                          ...
                                                          child: Column(
                                                            children: [
                                                              ...
                                                              Center(child: Text("ডিফল্ট",style: TextStyle(color: circleColor==1?Colors.red:Colors.black),))
                                                            ],
                                                          ),
                                                        ),
                                                        Padding(
                                                          ...
                                                          child:      InkWell(
                                                            onTap: (){
                                                              setState(() {
                                                                readingApiController.updateColorMode(Colors.white);
                                                            ...
                                                            child: Column(
                                                              children: [
                                                                ...
                                                                Center(child: Text("উজ্জ্বল",style: TextStyle(color: circleColor==2?Colors.red:Colors.black),))
                                                              ],
                                                            ),
                                                          ),
                                                        ),
                                                        InkWell(
                                                          onTap: (){
                                                            setState(() {
                                                              readingApiController.updateColorMode(Colors.white70);
                                                          ...
                                                          child: Column(
                                                            children: [
                                                              ...
                                                              Center(child: Text("পেপার",style: TextStyle(color: circleColor==3?Colors.red:Colors.black),))
                                                            ],
                                                          ),
                                                        ),
                                                        Padding(
                                                          ...
                                                          child:      InkWell(
                                                            onTap: (){
                                                              readingApiController.updateColorMode(Colors.indigo.shade900);
                                                            ...
                                                            child: Column(
                                                              children: [
                                                                ...
                                                                Center(child: Text("গাড় নীল",style: TextStyle(color: circleColor==4?Colors.red:Colors.black),))
                                                              ],
                                                            ),
                                                          ),
                                                        ),
                      ...
                      Column(
                        ...
                        children:  [
                          ...
                          Padding(
                            ...
                            child: Text('অধ্যায় ঃ ',style: TextStyle(fontSize: size.width*.03,color: Colors.black,),),
                          ),
                        ],),
                      Padding(
                  ...
                  endDrawer:Drawer(
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: ListView(
                          children:  [
                            Text('Line Alignment',style: TextStyle(fontSize: 20),),
                            Padding(
                              ...
                              child: Row(
                                ...
                                children:  [
                                  IconButton(
                                    ...
                                    icon: Icon(Icons.format_align_left,size: 25.0,),),
                                  IconButton(
                                    onPressed: (){
                                      setState(() {
                                        alignment='justify';
                                    ...
                                    icon: Icon(Icons.format_align_justify_outlined,size: 25.0,),),
                                  ...
                                  IconButton(
                                    ...
                                    icon: Icon(Icons.format_align_right,size: 25.0,),),
                                ],),
                            ),
   ...
   // print(' ssss${readingApiController.selectedFont.value}');
    selectableTextWidget = SelectableText.rich(
      TextSpan(
       ...
       textAlign:   alignment=='justify'? TextAlign.justify:alignment=='rightAlign'?TextAlign.right:TextAlign.left,
